...
export default function RemixIcon(props: { className?: string; style?: string; }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" fill="none" className={props.className} style={props.style}>
            <g filter="url(#remix-filter)" fill="#E8F2FF">
            ...
            <defs>
                <filter id="remix-filter" x="131" y="99" width="539" height="601" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
