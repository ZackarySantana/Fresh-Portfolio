    ...
    function (Godot) {
        ...
        rename: function (old_path, new_path) {
          ...
          try {
            if (FS.trackingDelegate["willMovePath"]) {
              FS.trackingDelegate
                ["willMovePath"](old_path, new_path);
            }
          } catch (e) {
            err(
      ...
      var SOCKFS = {
        mount: function (mount) {
          ...
          Module["websocket"].emit = function (event, param) {
            if ("function" === typeof this._callbacks[event]) {
              this
                ._callbacks[event].call(this, param);
            }
          };
        ...
        websocket_sock_ops: {
          ...
          poll: function (sock) {
            ...
            if (
              !dest || dest && dest.socket.readyState === dest.socket.OPEN
            ) {
              mask |= 4;
            }
            if (
          ...
          getname: function (sock, peer) {
            ...
            if (peer) {
              if (
                sock.daddr === undefined || sock.dport === undefined
              ) {
          ...
          sendmsg: function (sock, buffer, offset, length, addr, port) {
            if (sock.type === 2) {
              ...
              if (addr === undefined || port === undefined) {
                throw new FS
                  .ErrnoError(ERRNO_CODES.EDESTADDRREQ);
              }
            } else {
              addr = sock.daddr;
              port = sock.dport;
      ...
      function setMainLoop(
        ...
        Browser.mainLoop.runner = function Browser_mainLoop_runner() {
          ...
          if (Browser.mainLoop.queue.length > 0) {
            ...
            console.log(
              'main loop blocker "' + blocker.name + '" took ' +
                (Date.now() - start) + " ms",
            );
          ...
          if (!checkIsRunning()) return;
          if (
            typeof SDL === "object" && SDL.audio && SDL.audio.queueNewAudioData
          ) {
      ...
      var Browser = {
        ...
        init: function () {
          ...
          Browser.URLObject = typeof window != "undefined"
            ...
            : undefined;
          if (
            !Module.noImageDecoding && typeof Browser.URLObject === "undefined"
          ) {
            console.log(
          ...
          imagePlugin["handle"] = function imagePlugin_handle(
            ...
            if (Browser.hasBlobConstructor) {
              try {
                ...
                warnOnce(
                  "Blob constructor present but fails: " + e +
        ...
        calculateMouseEvent: function (event) {
          if (Browser.pointerLock) {
            if (event.type != "mousemove" && "mozMovementX" in event) {
              Browser
                .mouseMovementX = Browser.mouseMovementY = 0;
            } else {
      ...
      var GL = {
        ...
        createOffscreenFramebuffer: function (context) {
          ...
          if (gl.getContextAttributes().antialias) {
            context
              .defaultFboForbidBlitFramebuffer = true;
          } else {
            var firefoxMatch = navigator.userAgent.toLowerCase().match(
              /firefox\/(\d\d)/,
            );
        ...
        initExtensions: function (context) {
          ...
          if (context.version >= 2) {
            GLctx.disjointTimerQueryExt = GLctx
              .getExtension("EXT_disjoint_timer_query_webgl2");
          }
          if (context.version < 2 || !GLctx.disjointTimerQueryExt) {
            GLctx
              .disjointTimerQueryExt = GLctx.getExtension(
      ...
      function _emscripten_glBufferData(target, size, data, usage) {
        if (GL.currentContext.version >= 2) {
          if (data) GLctx.bufferData(target, HEAPU8, usage, data, size);
      ...
      function _emscripten_glDrawArraysInstanced(
        mode,
        first,
        count,
        primcount,
        ...
        if (ret === undefined) {
          ...
          switch (typeof result) {
            ...
            default:
              ...
              err(
                "GL_INVALID_ENUM in glGet" + type +
                  "v: Native code calling glGet" + type + "v(" + name_ +
      ...
      function _emscripten_glGetFramebufferAttachmentParameteriv(
        ...
        if (
          result instanceof WebGLRenderbuffer || result instanceof WebGLTexture
        ) {
      ...
      function _emscripten_webgl_init_context_attributes(attributes) {
        var a = attributes >> 2;
        for (var i = 0; i < 56 >> 2; ++i) HEAP32[a + i] = 0;
        HEAP32[a + (0 >> 2)] =
          HEAP32[a + (4 >> 2)] =
          HEAP32[a + (12 >> 2)] =
          HEAP32[a + (16 >> 2)] =
      ...
      function _godot_js_display_glGetBufferSubData(
        target,
        offset,
        size,
        data,
      ...
      function _godot_js_rtc_pc_remote_description_set(
        ...
        ref.setRemoteDescription({ "sdp": sdp, "type": type }).then(
          function () {
      ...
      var GodotWebXR = {
        ...
        monkeyPatchRequestAnimationFrame: (enable) => {
          if (GodotWebXR.orig_requestAnimationFrame === null) {
            GodotWebXR
              .orig_requestAnimationFrame = Browser.requestAnimationFrame;
          }
          ...
          GodotWebXR.session.inputSources.forEach((input_source) => {
            if (input_source.targetRayMode === "tracked-pointer") {
              if (input_source.handedness === "right") {
                ...
                input_source.handedness === "left" || !controllers[0]
              ) {
          ...
          function (session) {
            ...
            [
              ...
              session.addEventListener(input_event, function (evt) {
                ...
                oninputevent(
                  c_str,
                  GodotWebXR.getControllerId(evt.inputSource),
                );
                GodotRuntime.free(c_str);
              });
            });
      ...
      function _localtime_r(time, tmPtr) {
        ...
        var yday = (date.getTime() - start.getTime()) / (1e3 * 60 * 60 * 24) |
          0;
        HEAP32[tmPtr + 28 >> 2] = yday;
      ...
      function _strftime(s, maxsize, format, tm) {
        ...
        var EXPANSION_RULES_2 = {
          ...
          "%V": function (date) {
            ...
            var daysDifference;
            if (
              firstWeekStartThisYear.getFullYear() < date.tm_year + 1900
            ) {
              daysDifference = date.tm_yday + 32 -
                firstWeekStartThisYear.getDate();
            } else {
              daysDifference = date.tm_yday + 1 -
                firstWeekStartThisYear.getDate();
            }
      ...
      for (var i = 0; i < 288; ++i) {
        __miniTempWebGLIntBuffers[i] = __miniTempWebGLIntBuffersStorage
          .subarray(0, i + 1);
      }
      ...
      var __Z13godot_js_mainiPPc = Module["__Z13godot_js_mainiPPc"] =
        function () {
          return (__Z13godot_js_mainiPPc =
            Module["__Z13godot_js_mainiPPc"] =
      ...
      var __emwebxr_on_input_event = Module["__emwebxr_on_input_event"] =
        function () {
          return (__emwebxr_on_input_event =
      ...
      var __emwebxr_on_simple_event = Module["__emwebxr_on_simple_event"] =
        function () {
          return (__emwebxr_on_simple_event =
      ...
      var __get_tzname = Module["__get_tzname"] = function () {
        return (__get_tzname = Module["__get_tzname"] = Module["asm"]["qk"])
          .apply(null, arguments);
      };
      var __get_daylight = Module["__get_daylight"] = function () {
        return (__get_daylight = Module["__get_daylight"] = Module["asm"]["rk"])
          .apply(null, arguments);
      };
      var __get_timezone = Module["__get_timezone"] = function () {
        return (__get_timezone = Module["__get_timezone"] = Module["asm"]["sk"])
          .apply(null, arguments);
      };
      ...
      var stackRestore = Module["stackRestore"] = function () {
        return (stackRestore = Module["stackRestore"] = Module["asm"]["uk"])
          .apply(null, arguments);
      };
      ...
      var dynCall_iij = Module["dynCall_iij"] = function () {
        return (dynCall_iij = Module["dynCall_iij"] = Module["asm"]["yk"])
          .apply(null, arguments);
      };
